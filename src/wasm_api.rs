...
impl HwpDocument {
    ...
    pub fn set_page_number_position(
        &mut self,
        sec: u32,
        position: u32,
        format: u32,
        ...
        self.set_page_number_position_native(
            sec as usize,
            position.min(255) as u8,
            format.min(255) as u8,
            dash,
        )
        .map_err(|e| e.into())
    }
    ...
    pub fn get_page_number_position(&self, sec: u32) -> Result<String, JsValue> {
        self.get_page_number_position_native(sec as usize)
            .map_err(|e| e.into())
    }
